...
import com.ttn.ecommerce.security.AppUser;
...
//            }
    ...
    public String saveNewCustomer(CustomerRegisterModel customerRegisterModel) {
        ...
        User existingUser = userRepository.findByEmail(customerRegisterModel.getEmail());
    ...
    public String saveNewSeller(SellerRegisterModel sellerRegisterModel) {
        ...
        User existingUser = userRepository.findByEmail(sellerRegisterModel.getEmail());
        if(existingUser != null)
        {
            return "This email already exists";
        }
    ...
    public String enableSellerAccount(Integer sellerId){
        ...
        if (seller.isPresent()){
            ...
            throw new UserNotFoundException("Seller not found", HttpStatus.NOT_FOUND);
    }
...
//        AppUser appUser = (AppUser) authentication.getPrincipal();
    ...
    public String resendActivationToken(String email) {
        ...
        if (user!=null) {
            ...
            throw new UserNotFoundException("Invalid EmailID entered", HttpStatus.NOT_FOUND);
        }
    }
